...
def get_args():
    ...
    parser.add_argument('--network', type = str, default='vgg_nb', help = 'model')
    # training settings
    ...
    # imbalance
    parser.add_argument('--loss_beta', type = float, default= 0.8, help = 'beta')
    parser.add_argument('--clamp_thres', type = float, default= 0, help = 'clamp thres for proto factor, as 0 or 1')
    parser.add_argument('--init_iter', type = int, default=15, help = 'proto-based loss after the init_iter')
    parser.add_argument('--proto_type', type = str, default='fc', help='fc | logit')
    parser.add_argument('--global_proto_type', type = str, default='gaussian', help='avg | gaussian')
    parser.add_argument('--tau', type = float, default=3.0, help = 'adjust for cosine score')
